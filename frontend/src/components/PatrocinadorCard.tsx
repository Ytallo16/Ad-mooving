...
const PatrocinadorCard = ({ patrocinador, index }: PatrocinadorCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className={`h-full overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border-2 ${categoriaInfo.borderColor} bg-gradient-to-br ${categoriaInfo.bgGradient}`}>
